...
class TaskManager:
    ...
    async def fetch(self):
        ...
        while not self.queue_in.empty():
            ...
            function, args, kwargs, meta = asyncm.serializer.deserialize_task(task)
    ...
    async def invokeOnMain(self, function, *args, ignore_result=False, **kwargs):
        ...
        self.queue_out.put(
            (
                "main",
                self.info.name,
                asyncm.serializer.serialize_task(function, args, kwargs),
                internal_id,
            )
        )
